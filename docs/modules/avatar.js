...
export const getSvgAvatar = async function (seed) {
  try {
    ...
    console.log('Could not get avatar image', err.stack)
    return getDefaultSvg()
  }
}

const getAvatarUrl = function (seed = getRandomId()) {
